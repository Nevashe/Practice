...
import static homework5.Dao.StudentDAO.getAllStudents;
...
public class MainTask {
    /*
            ...
            5. Создать JSP-страницу, на которой в таблице отобразить список студентов с кнопками для добавления,
